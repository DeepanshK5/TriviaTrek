...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class LottieLibraryAccessors extends SubDependencyFactory {
        private final LottieComposeLibraryAccessors laccForLottieComposeLibraryAccessors = new LottieComposeLibraryAccessors(owner);

        public LottieLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>lottie.compose</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public LottieComposeLibraryAccessors getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForLottieComposeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class LottieComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public LottieComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v641</b> with <b>com.airbnb.android:lottie-compose</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV641() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("lottie.compose.v641");
        }
    ...
    public static class MongodbDriverKotlinLibraryAccessors extends SubDependencyFactory {
        private final MongodbDriverKotlinCoroutineLibraryAccessors laccForMongodbDriverKotlinCoroutineLibraryAccessors = new MongodbDriverKotlinCoroutineLibraryAccessors(owner);

        public MongodbDriverKotlinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>mongodb.driver.kotlin.coroutine</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MongodbDriverKotlinCoroutineLibraryAccessors getCoroutine() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMongodbDriverKotlinCoroutineLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class MongodbDriverKotlinCoroutineLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public MongodbDriverKotlinCoroutineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v511</b> with <b>org.mongodb:mongodb-driver-kotlin-coroutine</b> coordinates and
         * with version reference <b>mongodbDriverKotlinCoroutineVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV511() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mongodb.driver.kotlin.coroutine.v511");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lottieComposeVersion</b> with value <b>6.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mongodbDriverKotlinCoroutine</b> with value <b>5.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mongodbDriverKotlinCoroutineVersion</b> with value <b>5.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMongodbDriverKotlinCoroutineVersion() { return getVersion("mongodbDriverKotlinCoroutineVersion"); }
